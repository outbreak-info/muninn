...
async def create_all():
    ...
    await run_sql_file('sql/intra_host_translations/create_fk_sample_id.sql')
    await run_sql_file('sql/intra_host_translations/create_fk_amino_acid_id.sql')
    await run_sql_file('sql/intra_host_translations/create_ix_amino_acid_id_sample_id.sql')
