...
class TempHaMouseFerretDmsTsv(FileFormat):
    ...
    async def insert_from_file(cls, filename: str) -> None:
        ...
        with open(filename, 'r') as f:
            ...
            for row in reader:
                ...
                data_cols = {cls.ColNameMapping.ferret_sera_escape, cls.ColNameMapping.mouse_sera_escape}
    ...
    def _verify_header(cls, reader: DictReader) -> None:
        required_cols = {cn.value for cn in {
            ...
            cls.ColNameMapping.ferret_sera_escape,
            cls.ColNameMapping.mouse_sera_escape
        }}
