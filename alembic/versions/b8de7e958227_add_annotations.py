...
Revision ID: b8de7e958227
Revises: dae15b3195bb
Create Date: 2025-07-07 15:31:30.825734
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['amino_acid_id'], ['amino_acids.id'], name=op.f('fk_annotations_amino_acid_id_amino_acids')),
    ...
    sa.UniqueConstraint('amino_acid_id', 'effect_id', name='uq_annotations_amino_acid_effect')
    )
