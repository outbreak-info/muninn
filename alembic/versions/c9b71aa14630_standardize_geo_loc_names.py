...
1. psql> update samples set geo_location_id = NULL;
2. psql> delete from geo_locations;
3. alembic upgrade head
4. run data ingestion

This avoids truncating samples, which would cascade to variants and mutations,
which would make the db less useful while the ingestion runs.
"""
